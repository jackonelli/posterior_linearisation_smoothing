...
def main():
    ...
    measurements = modify_meas(measurements, states, meas_model)
    ...
    ms_lm_ieks, Ps_lm_ieks, cost_lm_ieks, rmses_lm_ieks, neeses_lm_ieks = run_smoothing(
        LmIeks(motion_model, meas_model, num_iter, 10, 1e0, 10),
        states,
        measurements,
        prior_mean,
        prior_cov,
...
def modify_meas(measurements, states, meas_model):
