...
from src.slr.monte_carlo import McSlr as Slr
...
class Filter(ABC):
    ...
    def filter_seq(
        ...
        for k in np.arange(1, K + 1):
            ...
            x_k_kminus1, P_k_kminus1 = self._predict(x_kminus1_kminus1, P_kminus1_kminus1)

            x_k_k, P_k_k = self._update(y_k, x_k_kminus1, P_k_kminus1)
    ...
    def _predict(self, x_kminus1_kminus1, P_kminus1_kminus1):
        """KF prediction step
        ...
        """
        A, b, Omega = self._motion_lin(x_kminus1_kminus1, P_kminus1_kminus1)
    ...
    def _update(self, y_k, x_k_kminus1, P_k_kminus1):
        """KF update step
        Args:
            y_k
            x_k_kminus1: x_{k | k-1}
        ...
        Returns:
            ...
            P_k_k: P_{k | k}
        """
        H, c, R = self._meas_lin(x_k_kminus1, P_k_kminus1)
